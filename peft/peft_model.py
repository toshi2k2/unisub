...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.SUBSPACEADAPTER: SubspaceAdapterModel,
}
...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
    ...
    def save_pretrained(
        ...
        save_subspaceadapter_loadings:bool = True,
        save_subspaceadapter_components:bool = True,
        **kwargs: Any,
    ) -> None:
        r"""
        ...
        for adapter_name in selected_adapters:
            ...
            output_state_dict = get_peft_model_state_dict(
                ...
                save_subspaceadapter_loadings=save_subspaceadapter_loadings,
                save_subspaceadapter_components = save_subspaceadapter_components
            )

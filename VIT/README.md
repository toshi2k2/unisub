...
For the newer alpha/scree follow-up analysis built on top of this directory, start with [`../Main_weight_analysis/vit/README.md`](../Main_weight_analysis/vit/README.md).
